export default function SmartCommunication() {
  return (
    <div className="bg-slate-100 py-16 px-6 flex flex-col items-center">
      ...
      <p className="text-sm text-gray-500 text-center max-w-3xl mb-12 leading-relaxed">
      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        {/* Card 1 */}
        <div className="bg-white w-[260px] p-6 rounded-xl shadow-sm border border-gray-200">
